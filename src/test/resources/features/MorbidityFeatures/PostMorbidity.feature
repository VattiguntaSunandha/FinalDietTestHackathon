...
Feature: Validate and Test Post Request for Morbidity API with authorization
 ...
 @Regression @Functional
  ...
  @NegativetestPostMorbidityDataMissing @Functional @Smoke @Regression
  Scenario Outline: Checking if user is able to add a new record with missing items successfully
   ...
   @NegativetestPostMorbidityNoData @Functional @Smoke @Regression
   ...
   @NegativetestPostMorbidityInvalidAuthorization @Functional @Smoke @Regression
