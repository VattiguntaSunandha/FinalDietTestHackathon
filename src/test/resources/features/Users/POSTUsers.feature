...
Feature: Validate and Test POST request for Users API 
  ...
  @userspostexistsfnameconemail @Functional @Smoke @Regression
  ...
  @userspostnomandfields @Functional @Smoke @Regression
  ...
  @userspostemptybody @Functional @Smoke @Regression
  ...
  @userspostneusertype @Functional @Smoke @Regression
